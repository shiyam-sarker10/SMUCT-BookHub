              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                >
                    ...
                    <div className="flex items-start">
                      <div className="flex items-center h-5">
                        <input
                          ...
                          type="checkbox"
                          className=" form-checkbox accent-[#201F5E]  text-[#201F5E] w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800"
                          required=""
                        />
                      </div>
                  ...
                  <div className="flex justify-center items-center ">
                    <input
                      className="px-6 w-full py-2 rounded-lg  active:bg-[#201F5E]/80 font-medium bg-[#201F5E] text-white font-title "
                      type="submit"
                      value="Submit"
                    />
                  </div>
                  <div className="inline-flex items-center justify-center w-full relative">
                    ...
                    <span className="absolute px-3 font-medium  -translate-x-1/2 bg-white left-1/2 dark:text-white text-[#201F5E] dark:bg-gray-900">
                      or
                    </span>
                  </div>
